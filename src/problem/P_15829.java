...
public class P_15829 implements Problem {
    ...
    public static List<String> output = List.of("4739715", "25818", "9");

    static final int primeM = 1234567891;
    static final int primeR = 31;
    ...
    public void exec() throws Exception {
        ...
        for (int i=0; i<L; i++) {
            hash += (str.charAt(i)-96) * pow % primeM;

            // 거듭제곱을 할수록 숫자가 너무 커져서 모듈러 분배 연산
            pow = pow * primeR % primeM;
        }
