...
public class P_2630 implements Problem {
    ...
    // 자른 종이의 색이 모두 같은지 판단 함수
    static boolean isSameColor(int x, int y, int size) {

        boolean baseColor = paper[x][y];

        // color 와 다르면 false 반환
